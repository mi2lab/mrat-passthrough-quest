...
// AVATAR SDK END
        ...
        // [KeywordEnum(None, BaseColor, Occlusion, Roughness, Metallic, Thickness, Normal, Normal Map, Emissive, View, Punctual, Punctual Specular, Punctual Diffuse, IBL, SH, No Tone Map, SubSurface Scattering)] Debug("Debug Render", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // #pragma multi_compile __ DEBUG_BASECOLOR DEBUG_OCCLUSION DEBUG_ROUGHNESS DEBUG_METALLIC DEBUG_THICKNESS DEBUG_NORMAL DEBUG_NORMAL_MAP DEBUG_EMISSIVE DEBUG_VIEW DEBUG_PUNCTUAL DEBUG_PUNCTUAL_SPECULAR DEBUG_PUNCTUAL_DIFFUSE DEBUG_IBL DEBUG_SH DEBUG_NO_TONE_MAP DEBUG_SUBSURFACE_SCATTERING
