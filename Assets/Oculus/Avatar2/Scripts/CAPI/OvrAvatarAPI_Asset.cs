...
namespace Oculus.Avatar2
{
    public partial class CAPI
    {
        ...
        public enum ovrAvatar2MaterialExtensionEntryType {
            ImageId = 0,
            Float = 1,
            Int = 2,
            Vector3f = 3,
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern unsafe CAPI.ovrAvatar2Result ovrAvatar2Primitive_GetMaterialExtensionName(
            ovrAvatar2Id id,
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2Primitive_GetNumEntriesInMaterialExtensionByIndex(
            ovrAvatar2Id id,
            UInt32 extensionIndex,
            out UInt32 numEntries);

        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern CAPI.ovrAvatar2Result ovrAvatar2Primitive_MaterialExtensionEntryMetaDataByIndex(
            ovrAvatar2Id id,
        ...
        [DllImport(LibFile, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe CAPI.ovrAvatar2Result ovrAvatar2Primitive_MaterialExtensionEntryDataByIndex(
            ovrAvatar2Id id,
            UInt32 materialExtensionIndex,
            UInt32 entryIndex,
            byte* nameBuffer,
